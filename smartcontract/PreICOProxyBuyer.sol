 ...
 */
contract FractionalERC223 is ERC223 {
...
contract PreICOProxyBuyer is Ownable, Haltable, SafeMath {
   ...
   */
  function getToken() public constant returns(FractionalERC223) {
